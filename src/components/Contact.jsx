        ...
        <div className="flex flex-col lg:flex-row items-center justify-around px-6 lg:px-10 py-10">
            ...
            <h1 className="text-3xl  sm:text-4xl md:text-5xl lg:text-6xl font-bold text-black">
                ...
                <div className="">
                    ...
                    <p className="text-sm text-gray-700">Sector 11C/45, Karkunj Road,
                    <br />
                    im front of Anthem Street, Agra -282007(U.P.)
                    </p>
                </div>
                <div>
                ...
                <p className="mt-8 lg:mt-12 font-bold text-green-800 text-2xl underline">+91-7078633060</p>
